...
mongoose.connect('mongodb://nazim:6135046@ds013574.mlab.com:13574/nzm');
    ...
    var blog = new Blog(
        {
            ...
            article_des : req.body.article_des,
            addr : req.body.addr,
...
app.post('/api/editBlog/:id', function (req, res) {
    ...
    Blog.findById( req.params.id, function ( err, blog ) {
            ...
            blog.article_des = req.body.article_des,
            blog.addr = req.body.addr 
                         // http://mongoosejs.com/docs/api.html#model_Model-save
        blog.save( function ( err, data ){
            if(!err && data){
                res.redirect('/blogs')
